        ...
        <div>
          <div className="card-table" style={{ padding: '28px', marginBottom: '24px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '20px' }}>
              ...
              <div>
                <h3 style={{ fontSize: '1.2rem', fontWeight: 700 }}>פלטת ממשק הקליניקה (CRM)</h3>
                <p style={{ fontSize: '0.85rem', color: '#64748b' }}>
                  הפלטה צובעת את ממשק הניהול של הקליניקה בלבד. למרחב האישי של כל מטופל נבחרת פלטה נפרדת בכרטיס הלקוח, וממשק הסופראדמין תמיד בגוון ניטרלי.
                </p>
              </div>
            </div>
