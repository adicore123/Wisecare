...
export default function LiveKitManager() {
  ...
  const scheduleStatusMeta = (status: string): { label: string; bg: string; color: string } => {
    switch (status) {
      ...
      case 'started': return { label: 'החלה', bg: 'var(--primary-light)', color: 'var(--primary-hover)' };
  ...
  return (
    <div className="page-content" dir="rtl">
      ...
      {videoDisabled ? (
        ...
        .lk-tab:hover { border-color: var(--primary-light); color: var(--primary-hover); }
        .lk-tab.active {
        ...
        .lk-tab-badge {
          ...
          background: color-mix(in srgb, var(--primary) 12%, transparent); color: var(--primary-hover);
      ...
      `}</style>
            ...
            <div className="card" style={{
              ...
              <div style={{ fontSize: '0.93rem', lineHeight: 1.65 }}>
                ...
                <div style={{
                  ...
                  background: 'rgba(15, 23, 42, 0.92)', color: 'var(--primary-light)',
          ...
          {status?.configured && (
            <div style={{
              ...
              background: 'color-mix(in srgb, var(--primary) 10%, transparent)', border: '1px solid color-mix(in srgb, var(--primary) 30%, transparent)',
              fontSize: '0.88rem', color: 'var(--primary-hover)', fontWeight: 500
            }}>
          ...
          {activeCall && (
            <div className="card" style={{
              ...
              border: '1px solid color-mix(in srgb, var(--primary) 25%, transparent)', borderRadius: '14px'
            }}>
              ...
              <div style={{
                ...
                padding: '12px 18px', flexWrap: 'wrap', borderTop: '1px solid color-mix(in srgb, var(--primary) 15%, transparent)'
              }}>
                          ...
                          <tr key={s.id}>
                            ...
                            <td data-label="מרחב">
                              <span className="lk-chip" style={{
                                background: s.clientHasPortal ? 'var(--primary-faint)' : '#f8fafc',
                                color: s.clientHasPortal ? 'var(--primary-hover)' : '#64748b'
                              }}>
                      ...
                      {filteredCalls.slice(0, 50).map((c) => {
                        ...
                        return (
                          <tr key={c.id}>
                            ...
                            <td data-label="משך">
                              <span style={{ fontFamily: 'monospace', fontSize: '0.86rem', color: active ? 'var(--primary-hover)' : '#475569', fontWeight: 600 }}>
                            ...
                            <td data-label="סטטוס">
                              <span className="lk-chip" style={{
                                background: active ? 'var(--primary-light)' : '#f1f5f9',
                                color: active ? 'var(--primary-hover)' : '#64748b'
                              }}>
                                <span className={`lk-dot${active ? ' lk-dot-pulse' : ''}`} style={{ background: active ? 'var(--primary)' : '#94a3b8' }} />
