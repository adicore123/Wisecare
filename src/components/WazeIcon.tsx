...
/**
 * Official Waze Brand SVG — the authentic logo path (24×24) as published in
 * the Waze brand guidelines, embedded raw: the speech bubble with its two
 * eyes and smile as negative space and the location-pin arcs at the bottom.
 * Filled with the official Waze blue (#33CCFF).
 */
