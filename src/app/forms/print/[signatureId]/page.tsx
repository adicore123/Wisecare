    ...
    <div style={{ direction: 'rtl', fontFamily: 'inherit' }}>
      ...
      <div style={{ textAlign: 'center', padding: '14px', background: '#f1f5f9' }} className="no-print">
        <button
          ...
          style={{ background: '#0d9488', color: '#fff', border: 'none', borderRadius: '8px', padding: '8px 20px', fontSize: '0.9rem', fontWeight: 700, cursor: 'pointer' }}
        >
          🖨️ הדפסה / שמירה כ-PDF
        </button>
      </div>
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', borderBottom: `3px double ${t.accentColor || '#0d9488'}`, paddingBottom: 10, marginBottom: 14 }}>
          <div style={{ fontSize: '16pt', fontWeight: 800, color: t.accentColor || '#0d9488' }}>{t.title || t.name || 'מסמך חתום'}</div>
