...
export default function TherapistLoginPage({ loginCode, onLoginSuccess }) {
  const [workspace, setWorkspace] = useState(null);
  const [loadingInfo, setLoadingInfo] = useState(Boolean(loginCode));
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (response && response.user) {
        // Superadmin must log in only via /superadmin dedicated gate
