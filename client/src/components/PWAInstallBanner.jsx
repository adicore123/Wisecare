          ...
          {deferredPrompt && !installedSuccess && (
            <div className="mt-3 flex items-center gap-2">
              <button
                ...
                className="flex min-h-11 flex-1 items-center justify-center gap-1.5 rounded-xl bg-brand-700 px-3 py-2 text-xs font-semibold text-white shadow-lg shadow-teal-950/20 transition-colors hover:bg-brand-600 active:bg-brand-800"
              >
